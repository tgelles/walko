...
$j('#arrangements').imagesLoaded( function() {
  //set isotope variables
   var $container = $j('#arrangements'),
      filters = {};

   $container.isotope({
        itemSelector: '.arrangement',
        layoutMode : 'masonry'    });

    // filter buttons
    $j('.filter a.btn.btn-default').click(function(){
      var $this = $j(this);
  ...
  //Setup quicksearch
    $j('#id_search').quicksearch('div.arrangement', {
      delay: 100,
      bind: 'onchange keyup',
    noResults: '#noresults',
        'show': function() {
